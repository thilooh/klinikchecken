  ...
  const cols = [
    {
      ...
      links: ['Über uns', 'Presse', 'Jobs', 'Kontakt'],
      text: 'Das führende Vergleichsportal für ästhetische Medizin in Deutschland.',
    },
    {
      title: 'Für Kliniken',
      links: ['Klinik eintragen', 'Preise & Pakete', 'Partner werden', 'Klinik-Login'],
    },
    {
      title: 'Behandlungen',
      links: ['Besenreiser', 'Krampfadern', 'Botox', 'Filler', 'Laser', 'Hyaluron'],
    },
    {
      title: 'Rechtliches',
      links: ['Datenschutz', 'Impressum', 'AGB', 'Cookie-Einstellungen', 'Barrierefreiheit'],
    },
  ]
