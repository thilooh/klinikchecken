        ...
        <div style={{ position: 'relative', flexShrink: 0 }}>
          ...
          {sortOpen && (
            <>
              ...
              <div style={{ position: 'absolute', top: 'calc(100% + 6px)', left: 0, backgroundColor: '#fff', border: '1px solid #DDD', borderRadius: '8px', boxShadow: '0 4px 16px rgba(0,0,0,0.12)', zIndex: 50, minWidth: '190px', overflow: 'hidden' }}>
